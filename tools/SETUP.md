...
시흥·천안 카드에서 인원을 눌러 고쳐도 됩니다. 주소에도 같이 적히므로 새로 고쳐도 남고,
**그 주소를 그대로 보내면 받는 사람도 똑같은 숫자를 봅니다.** 표 위에 지금 어떤 인원으로
보고 있는지 표시가 뜨고, 옆의 `기본값으로` 를 누르면 돌아옵니다.

주소에 아무것도 없으면 기본값 시흥 5 · 천안 11 로 봅니다.
